...
function handlerClick(event) {
  ...
  const modalImgDescr = event.target.dataset.descr;
  console.log("modalImgDescr:", modalImgDescr)
  
  const instance = basicLightbox.create(`
    <div class="modal">
    <img src="${linkOriginal}" alt="${modalImgDescr}">
    </div>`);
  
  instance.show();

   const modalClose = instance.element();
